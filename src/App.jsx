        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr 1fr 1fr", gap: 32, marginBottom: 40 }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
              <img src={LOGO_URI} alt="WBC" style={{ width: 44, height: 44 }} onError={e => e.target.style.display = "none"} />
      ...
      {!adminAuth ? (
        <div style={{ maxWidth: 400, background: C.card, borderRadius: 14, padding: 32, border: "1px solid " + C.border }}>
          <div style={{ display: "flex", justifyContent: "center", marginBottom: 20 }}>
            <img src={LOGO_URI} alt="WBC" style={{ width: 80, height: 80 }} onError={e => e.target.style.display = "none"} />
          </div>
